# LeCrown Development Platform

Development back-office application owned by `metroLecrown`.

Canonical repository: `https://github.com/benlagrone/lecrown-platform`.
Application source lives in `platform/`; run the commands below from that directory.
The existing certification portfolio, CSV data, and tracker remain at the repository root.

This source import contains no runtime database or credentials. Use a fresh Development
database; brokerage database migration and production cutover are not included.

The platform keeps content, transformation, distribution, government procurement, billing, and cross-site intake inside one codebase. The current tenant-scoped paths still use `development`, while generalized lead ingestion starts at `POST /intake/lead`.
...
- FastAPI backend with tenant-aware `content`, `linkedin`, `youtube`, `distribution`, `intake`, and `auth` routes
- Stripe-backed billing API for shared app accounts, checkout, customer portal, webhook sync, and entitlement lookup
- SQLite persistence through SQLAlchemy
- Minimal React admin for creating canonical content, choosing output channels, and reviewing Development operations
...
- `POST /content/create`
- `GET /content/list?tenant=development`
...
Production deployment remains governed by the workspace deployment capability.
No production cutover or credentials are included in this migration.
...
- The backend can call that worker over HTTP through [backend/app/services/video_client.py](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/backend/app/services/video_client.py).
...
- [docs/mediastudio-apis.md](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/mediastudio-apis.md)
...
The intake API accepts source-aware Development leads from connected sites.
...
- [docs/feature-roadmap.md](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/feature-roadmap.md)
- [docs/billing-platform-strategy.md](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/billing-platform-strategy.md)
- [docs/lecrown-billing-workflow-spec.md](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/lecrown-billing-workflow-spec.md)
...
- [Government Contracting Knowledge Base](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/government-contracting/README.md)
- [Subcontracting and Market-Access Plan](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/government-contracting/subcontracting-market-access-plan.md)
- [Government Contracts Platform Guide](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/gov-contracts.md)
...
- [Site Integration Overview](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/site-integration-overview.md)
...
- [ops/espocrm](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/ops/espocrm)
...
- [docs/gov-contracts.md](/Users/benjaminlagrone/Documents/projects/metroLecrown/platform/docs/gov-contracts.md)
...
```json
{
  "source_site": "lecrowndevelopment.com",
  "source_type": "wordpress",
  "form_provider": "WPForms",
  "form_id": "12",
  "external_entry_id": "481",
  "page_url": "https://lecrowndevelopment.com/contact/",
  "business_context": "LeCrown Development",
  "product_context": "Consulting",
  "metadata": {
  ...
  "lead": {
    ...
    "description": "Requesting a services consultation.",
    "source": "Website"
  }
}
```
...
- `POST /intake/lead` is the cross-site intake boundary.
- Employee access supports password authentication and configured Google Workspace authentication.
