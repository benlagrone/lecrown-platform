...
- Houston METRO
- DART Bonfire public opportunities (JSON import)
...
```cron
0 8 * * 1 cd /Users/benjaminlagrone/Documents/projects/metroLecrown/platform/backend && /usr/bin/python3 -m app.jobs.refresh_gov_contracts --window-days 7
```
