...
This mode supports custom Development service invoices.
...
- this mode is available for custom Development invoices
...
4. add Gmail API draft creation for the approved Development mailbox
