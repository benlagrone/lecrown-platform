...
class AuthServiceTest(unittest.TestCase):
    ...
    def test_missing_bootstrap_password_does_not_create_an_empty_password_account(self) -> None:
        with patch.object(auth_service.settings, "admin_password", ""):
            with self.Session() as db:
                self.assertIsNone(auth_service.ensure_bootstrap_admin_user(db))
