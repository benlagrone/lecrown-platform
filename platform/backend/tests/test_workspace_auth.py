...
class WorkspaceAuthTest(unittest.TestCase):
    ...
    def test_google_workspace_login_creates_member_and_configured_admin(self) -> None:
        identities = [
            WorkspaceIdentity("google-member", "member@lecrowndevelopment.com", "lecrowndevelopment.com"),
            WorkspaceIdentity("google-admin", "benjamin@lecrowndevelopment.com", "lecrowndevelopment.com"),
        ]
        with patch.object(
            ...
            ["benjamin@lecrowndevelopment.com"],
        ):
            with self.Session() as db:
                ...
                self.assertEqual("benjamin@lecrowndevelopment.com", admin.email)
    ...
    def test_workspace_login_links_existing_user_by_verified_email(self) -> None:
        with self.Session() as db:
            existing = User(
                id=new_uuid(),
                username="benjamin",
                email="benjamin@lecrowndevelopment.com",
    ...
    def test_verifier_rejects_non_workspace_and_nonce_mismatch(self) -> None:
        with patch.object(
            ...
            with self.assertRaisesRegex(WorkspaceAuthError, "LeCrown Development"):
        ...
        with patch.object(
            ...
            return_value={
                "sub": "workspace-user",
                "email": "member@lecrowndevelopment.com",
                "email_verified": True,
                "hd": "lecrowndevelopment.com",
                "nonce": "wrong-nonce",
            },
        ):
