...
source_config="$script_dir/nginx.client-portal.lecrownproperties.com.conf"
site_name="portal.lecrownproperties.com.conf"
...
echo "Installed and reloaded nginx for portal.lecrownproperties.com."
echo "After DNS resolves, issue TLS with:"
echo "  certbot --nginx -d portal.lecrownproperties.com"
